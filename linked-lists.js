...
// need current node values 
//current node next equals previous node 

// set the head to currNode
// loop through each next node
// set prevNode before looping to the next currNode
...
const reverse = linkedList => {
    ...
    while(currNode !== null) {
        let cachedNode = currNode.next; 
        currNode.next = prevNode; 
        prevNode = currNode; 
        currNode = cachedNode // continue to next while loop
    }
